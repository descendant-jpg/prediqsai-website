      ...
      <div className="mx-auto max-w-5xl px-5 sm:px-8">
        ...
        <div className="mt-12 grid items-stretch gap-6 md:grid-cols-2">
          <article className="flex flex-col rounded-2xl border border-edge bg-panel p-7 sm:p-8">
            ...
            <Link href="/register" className="mt-8 inline-flex items-center justify-center gap-2 rounded-lg border border-edge bg-panel-2 px-5 py-3 text-sm font-semibold transition hover:border-muted">Get started free <ArrowRight className="h-4 w-4" /></Link>
          </article>
